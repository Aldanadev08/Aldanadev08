...
<div>
  <p>👨‍💻 I am a <strong>Systems Engineering student</strong> from Guatemala, currently specializing as a <strong>full-stack developer</strong> with focus on mobile and web applications.</p>
...
<div style="margin: 20px 0;">
  <h3 style="text-align: center; font-weight: bold; color: #2E3A59;">🚀 <strong>Agile Methodologies & Project Management</strong></h3>
  <table style="width: 100%; border: none; text-align: center;">
    <tr>
      ...
      <td style="border: 2px solid green; padding: 10px; border-radius: 10px;">
        <img src="https://img.shields.io/badge/Kanban-%230052CC?style=for-the-badge&logo=kanban&logoColor=white" alt="Kanban" width="150">
      </td>
      <td style="border: 2px solid green; padding: 10px; border-radius: 10px;">
        <img src="https://img.shields.io/badge/Jira-0052CC?style=for-the-badge&logo=jira&logoColor=white" alt="Jira Software" width="150">
      </td>
      <td style="border: 2px solid green; padding: 10px; border-radius: 10px;">
        <img src="https://img.shields.io/badge/Trello-%23026AA7.svg?style=for-the-badge&logo=Trello&logoColor=white" alt="Trello" width="150">
      </td>
    </tr>
  </table>
</div>
...
<div style="margin: 20px 0;">
  <h3 style="text-align: center; font-weight: bold; color: #2E3A59;">📱 <strong>Mobile Development</strong></h3>
  <table style="width: 100%; border: none; text-align: center;">
    <tr>
      <td style="border: 2px solid purple; padding: 10px; border-radius: 10px;">
        <img src="https://img.shields.io/badge/react_native-%2320232a.svg?style=for-the-badge&logo=react&logoColor=%2361DAFB" alt="React Native" width="120">
      </td>
      <td style="border: 2px solid purple; padding: 10px; border-radius: 10px;">
        <img src="https://img.shields.io/badge/expo-1C1E24?style=for-the-badge&logo=expo&logoColor=#D04A37" alt="Expo" width="120">
      </td>
      <td style="border: 2px solid purple; padding: 10px; border-radius: 10px;">
        <img src="https://img.shields.io/badge/android%20studio-346ac1?style=for-the-badge&logo=android%20studio&logoColor=white" alt="Android Studio" width="120">
      </td>
    </tr>
  </table>
</div>
...
<div style="margin: 20px 0;">
  ...
  <table style="width: 100%; border: none; text-align: center;">
    <tr>
      ...
      <td style="border: 2px solid orange; padding: 10px; border-radius: 10px;">
        <img src="https://img.shields.io/badge/Voice_Recognition-4285F4?style=for-the-badge&logo=google-assistant&logoColor=white" alt="Voice Recognition" width="150">
      </td>
      <td style="border: 2px solid orange; padding: 10px; border-radius: 10px;">
        <img src="https://img.shields.io/badge/Whisper_API-412991?style=for-the-badge&logo=openai&logoColor=white" alt="Whisper API" width="150">
      </td>
    </tr>
  </table>
</div>
...
<div style="margin: 20px 0;">
  ...
  <table style="width: 100%; border: none; text-align: center;">
    <tr>
      ...
      <td style="border: 2px solid blue; padding: 10px; border-radius: 10px;">
        <img src="https://img.shields.io/badge/npm-CB3837?style=for-the-badge&logo=npm&logoColor=white" alt="NPM" width="100">
      </td>
      <td style="border: 2px solid blue; padding: 10px; border-radius: 10px;">
...
<div style="margin: 20px 0;">
  ...
  <table style="width: 100%; border: none; text-align: center;">
    <tr>
      ...
      <td style="border: 2px solid blue; padding: 10px; border-radius: 10px;">
        <img src="https://img.shields.io/badge/Axios-5A29E4?style=for-the-badge&logo=axios&logoColor=white" alt="Axios" width="100">
      </td>
    </tr>
  </table>
</div>
...
<div style="margin: 20px 0;">
  ...
  <table style="width: 100%; border: none; text-align: center;">
    ...
    <tr>
      ...
      <td style="border: 2px solid blue; padding: 10px; border-radius: 10px;">
        <img src="https://img.shields.io/badge/netlify-%23000000.svg?style=for-the-badge&logo=netlify&logoColor=#00C7B7" alt="Netlify" width="100">
      </td>
    </tr>
  </table>
</div>
...
<div style="margin: 20px 0;">
  <h3 style="text-align: center; font-weight: bold; color: #2E3A59;">🎨 <strong>Design & Prototyping</strong></h3>
  <table style="width: 100%; border: none; text-align: center;">
    <tr>
      <td style="border: 2px solid purple; padding: 10px; border-radius: 10px;">
      ...
      <td style="border: 2px solid purple; padding: 10px; border-radius: 10px;">
        <img src="https://img.shields.io/badge/Adobe%20XD-470137?style=for-the-badge&logo=Adobe%20XD&logoColor=#FF61F6" alt="Adobe XD" width="120">
      </td>
    </tr>
  </table>
</div>
...
<div style="margin: 20px 0;">
  ...
  <table style="width: 100%; border: none; text-align: center;">
    <tr>
      ...
      <td style="border: 2px solid blue; padding: 10px; border-radius: 10px;">
        <img src="https://img.shields.io/badge/REST_API-02569B?style=for-the-badge&logo=rest&logoColor=white" alt="REST API" width="100">
      </td>
    </tr>
  </table>
</div>
...
<div style="margin: 20px 0;">
  <h3 style="text-align: center; font-weight: bold; color: #2E3A59;">🔐 <strong>Cybersecurity & Best Practices</strong></h3>
  <table style="width: 100%; border: none; text-align: center;">
    <tr>
      <td style="border: 2px solid red; padding: 10px; border-radius: 10px;">
        <img src="https://img.shields.io/badge/Network_Security-FF0000?style=for-the-badge&logo=security&logoColor=white" alt="Network Security" width="130">
      </td>
      <td style="border: 2px solid red; padding: 10px; border-radius: 10px;">
        <img src="https://img.shields.io/badge/Penetration_Testing-8B0000?style=for-the-badge&logo=hackaday&logoColor=white" alt="Penetration Testing" width="130">
      </td>
      <td style="border: 2px solid red; padding: 10px; border-radius: 10px;">
        <img src="https://img.shields.io/badge/OWASP-000000?style=for-the-badge&logo=owasp&logoColor=white" alt="OWASP" width="130">
      </td>
    </tr>
    <tr>
      <td style="border: 2px solid red; padding: 10px; border-radius: 10px;">
        <img src="https://img.shields.io/badge/Security_Auditing-DC143C?style=for-the-badge&logo=shield&logoColor=white" alt="Security Auditing" width="130">
      </td>
      <td style="border: 2px solid red; padding: 10px; border-radius: 10px;">
        <img src="https://img.shields.io/badge/Secure_Coding-B22222?style=for-the-badge&logo=codacy&logoColor=white" alt="Secure Coding" width="130">
      </td>
      <td style="border: 2px solid red; padding: 10px; border-radius: 10px;">
        <img src="https://img.shields.io/badge/API_Security-8B0000?style=for-the-badge&logo=security&logoColor=white" alt="API Security" width="130">
      </td>
    </tr>
  </table>
</div>
...
<div style="margin: 20px 0;">
  ...
  <table style="width: 100%; border: none; text-align: center;">
    <tr>
      <td style="border: 2px solid green; padding: 10px; border-radius: 10px;">
        <img src="https://img.shields.io/badge/ERP_Systems-FF9900?style=for-the-badge&logo=sap&logoColor=white" alt="ERP Systems" width="130">
      </td>
      <td style="border: 2px solid green; padding: 10px; border-radius: 10px;">
        <img src="https://img.shields.io/badge/E--Commerce-00C7B7?style=for-the-badge&logo=shopify&logoColor=white" alt="E-Commerce" width="130">
      </td>
      <td style="border: 2px solid green; padding: 10px; border-radius: 10px;">
        <img src="https://img.shields.io/badge/CRM-0078D4?style=for-the-badge&logo=salesforce&logoColor=white" alt="CRM" width="130">
      </td>
    </tr>
    <tr>
      <td style="border: 2px solid green; padding: 10px; border-radius: 10px;">
        <img src="https://img.shields.io/badge/Inventory_Management-34A853?style=for-the-badge&logo=google-sheets&logoColor=white" alt="Inventory Management" width="130">
      </td>
      <td style="border: 2px solid green; padding: 10px; border-radius: 10px;">
        <img src="https://img.shields.io/badge/Payment_Gateways-635BFF?style=for-the-badge&logo=stripe&logoColor=white" alt="Payment Gateways" width="130">
      </td>
    </tr>
  </table>
</div>
...
<div style="margin: 20px 0;">
  ...
  <table style="width: 100%; border: none; text-align: center;">
    <tr>
      ...
      <td style="border: 2px solid blue; padding: 10px; border-radius: 10px;">
        <img src="https://img.shields.io/badge/Git_Flow-F05032?style=for-the-badge&logo=git&logoColor=white" alt="Git Flow" width="100">
      </td>
    </tr>
  </table>
</div>
